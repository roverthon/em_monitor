...
////	ret = ESP8266_ConnectServer_serve(SOCKET_MODE, SOCKET_IP, SOCKET_PORT);
//	ret = ESP8266_ConnectServer_LinkID(0, SOCKET_MODE, SOCKET_IP, SOCKET_PORT);
//	if(ret < 0)
//	{
